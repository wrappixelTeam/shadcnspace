    ...
    return (
        <div className="flex items-center gap-2">
            <TooltipProvider>
                <Tooltip>
                    <TooltipTrigger>
                        <div className="rounded-full p-3 bg-primary/5 group">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 32 32"><path stroke="var(--primary)" strokeLinecap="round" strokeWidth="4.48" d="m27.76 16.56l-11.2 11.2m8.96-23.52L4.24 25.52" /></svg>
                        </div>
                    </TooltipTrigger>
                    <TooltipContent>
                        <p>Shadcn</p>
                ...
                <Tooltip>
                    <TooltipTrigger>
                        <div className="rounded-full p-3 bg-primary/5 group">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 128 128"><path fill="var(--primary)" d="M64 0A64 64 0 0 0 0 64a64 64 0 0 0 64 64a64 64 0 0 0 35.508-10.838L47.014 49.34v40.238H38.4V38.4h10.768l57.125 73.584A64 64 0 0 0 128 64A64 64 0 0 0 64 0m17.777 38.4h8.534v48.776L81.777 75.97Zm24.18 73.92l-.111.096z" /></svg>
                        </div>
                    </TooltipTrigger>
                    <TooltipContent>
                        <p>Next.js</p>
                ...
                <Tooltip>
                    <TooltipTrigger>
                        <div className="rounded-full p-3 bg-primary/5 group">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 128 128"><path fill="var(--primary)" d="M48.379 39.997L23.063 88.003H0L19.77 50.52c3.064-5.814 10.708-10.523 17.078-10.523ZM104.937 52c0-6.631 5.162-12.002 11.531-12.002S128 45.368 128 52c0 6.629-5.162 12-11.532 12c-6.369 0-11.531-5.37-11.531-12.001M52.703 39.997h23.063L50.45 88.003H27.387Zm27.238 0h23.063L83.241 77.48c-3.065 5.814-10.715 10.523-17.084 10.523H54.625Z" /></svg>
                        </div>
                    </TooltipTrigger>
                    <TooltipContent>
                        <p>Motion</p>
                ...
                <Tooltip>
                    <TooltipTrigger>
                        <div className="rounded-full p-3 bg-primary/5 group">
                            <svg width="20" height="20" viewBox="0 0 17 24" fill="var(--primary)" aria-label="Base UI">
