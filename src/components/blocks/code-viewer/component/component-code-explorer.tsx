...
import { BlockCodeSidebar } from "./component-code-sidebar";
  ...
  return (
    <div className="relative h-full">
      <div
        ...
        className="h-full overflow-auto max-h-[50vh] max-w-[638px] text-sm [&_.line]:leading-[1.7] [&>pre]:h-full [&>pre]:overflow-x-auto [&>pre]:pt-4 [&>pre]:bg-background! dark:[--shiki-dark-bg:oklch(0.1296 0.0274 261.69)]"
      />
    </div>
  );
};
