...
export const BlockCodeSidebar = () => {
    ...
    return (
        <SidebarProvider
            className="bg-background min-h-80"
            style={
                {
                    "--sidebar-width": "16rem",
        ...
        >
            <Sidebar
                variant="inset"
                className="w-full data-[slot='sidebar-container']:relative z-0 bg-background h-auto"
                collapsible="none"
            >
                <SidebarGroupContent>
                    <SidebarGroup>
...
function TreeItem({ item }: { item: NodeItem<unknown> | TreeNode<unknown> }) {
    ...
    if ("filename" in item) {
        ...
        return (
            <SidebarMenuButton
                isActive={isActive}
                className="text-foreground/80 data-[state=active]:bg-accent relative text-sm! font-medium cursor-pointer"
    ...
    return (
        <SidebarMenuItem>
            ...
            >
                <CollapsibleTrigger>
                    <SidebarMenuButton className="text-foreground/80 text-sm font-medium cursor-pointer">
                        <Icon
